...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 79;
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = 60 * 60 * 2;

const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;

const uint64_t MONEY_SUPPLY                                  = UINT64_C(5300000000000000);
const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX                   = 0;
const size_t ZAWY_DIFFICULTY_V2                              = 0;
const uint8_t ZAWY_DIFFICULTY_DIFFICULTY_BLOCK_VERSION       = 1;
const unsigned EMISSION_SPEED_FACTOR                         = 22;
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(318000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "egamecash";
...
const int      P2P_DEFAULT_PORT                              =  35000;
const int      RPC_DEFAULT_PORT                              =  35001;
...
const char* const SEED_NODES[] = { "207.246.66.90:35000", "207.246.112.109:35000", "144.217.104.145:35000" };
} // CryptoNote
