...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 8217;
...
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(4500000000000);
...
const uint32_t UPGRADE_HEIGHT_V5                             = 711125;
...
const char     CRYPTONOTE_NAME[]                             = "scash";
...
const int      P2P_DEFAULT_PORT                              =  31000;
const int      RPC_DEFAULT_PORT                              =  31001;
...
const char* const SEED_NODES[] = { "node01.scsx.org:31000", "node02.scsx.org:31000" };
} // CryptoNote
